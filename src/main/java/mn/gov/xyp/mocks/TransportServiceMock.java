...
public class TransportServiceMock implements TransportService {
    ...
    public ServiceResponse ws100406GetCitizenVehicleList(VehicleRequestData request) {
        ...
        var v = new VehicleListData();
        v.setBuildYear("2022");
        v.setBuildMonth("01");
        v.setCabinNo("123456789");
        v.setCertificateNo("987654321");
        v.setCountryId(1);
        v.setCountryName("Japan");
        v.setCreatedDate(MockHelper.generateDate(2022, 1, 2));
        v.setEmissionClass("1");
        v.setEngineCapacity("1980");
        v.setFualName("92");
        v.setFualTypeId(1);
        v.setHolder("Mr Norman");
        v.setImportDate("2017");
        v.setMarkId(1);
        v.setMarkName("Prius");
        v.setOwner("Mr Norman");
        v.setPlateNo("0001УАА");
        v.setPurposeId("1");
        v.setPurposeName("Ride");
        v.setStatus("G");
        v.setStatusName("Good");
        v.setUpdatedDate(MockHelper.generateDate(2022, 1, 2));
        v.setVehicleTypeId(1);
        v.setVehicleTypeName("Toyota");
        v.setVehidleId(1);

        List<VehicleListData> response = new ArrayList<>();
        response.add(v);
